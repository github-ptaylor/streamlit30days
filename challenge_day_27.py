...
# Build applications using (Streamlit Elementts)

# Streamlit Elements is a third-party component made by okld that gives you the
# tools to compose beautiful applications and dashboards with Material UI widgets,
# Monaco editor (Visual Studio Code), Nivo charts, and more.


# Goal:
# 1. Create a dashboard composed of three Material UI cards:
